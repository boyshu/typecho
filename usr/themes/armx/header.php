...
<?php if($this->options->headerdesc){ echo ' - '.$this->options->headerdesc; }?>
</title>
...
<header id="header" class="header">
  <div class="container header-container clearfix"> <a id="logo" class="header-logo" title="<?php $this->options->title(); ?><?php if($this->options->headerdesc){ echo ' - '.$this->options->headerdesc; }?>" href="<?php $this->options->rootUrl(); ?>">
...
?> 2x"/>
    ...
    <?php endif;?>
    </a> <a class="menu-switch" id="menu-switch"><i class="fa fa-ellipsis-v headermenu"></i></a>
    <ul class="nav" id="nav">
      <li><a<?php if($this->is('index')){ ?> class="current"<?php } ?> href="<?php $this->options->rootUrl(); ?>">
        <?php _e('首页'); ?>
        </a></li>
    ...
    <div class="toolbar">
      <div class="dropdown" id="dropdown">
        ...
        <div class="dropdown-content">
          ...
          <?php endwhile; ?>
          <?php echo formaturl($this->options->headerdropsite,$this->options->rootUrl); ?> </div>
      </div>
      <div class="search-bar" id="search-bar">
        <div class="search-input" id="search-input">
          <form method="post" action="" id="search">
            <input autocomplete="off" name="s" type="text" required="required" placeholder="" id="s" value="<?php echo $this->request->filter('url', 'search')->keywords; ?>" />
          </form>
        </div>
        <a href="<?php $this->options->rootUrl(); ?>/search.html" class="search-btn"><i class="fa fa-search"></i></a> </div>
      ...
      <span class="night-mode" id="night-mode" title="夜间模式" onclick="tmode()"><i class="fa fa-lightbulb-o"></i></span>
      <?php endif;?>
    </div>
  </div>
</header>
