...
<footer id="footer" class="footer">
  ...
  <div class="copyright">POWERED BY <?php echo formaturl($this->options->powerby,$this->options->rootUrl); ?>, THEME BY <a href="<?php $this->options->rootUrl(); ?>/go/armx" target="_blank">ARMX</a> & <a href="<?php $this->options->rootUrl(); ?>/go/armx" target="_blank" id="copyright">VIRCLOUD</a>.</div>
  <div class="footer-line"></div>
  <div class="footer-site"><?php echo formaturl($this->options->footersite,$this->options->rootUrl); ?></div>
  <div class="footer-time"> 本站小水管已运行<span id="htmer_time">
    <?php uptime(0); ?>
    </span>秒
    ...
    <div style="display: none;" id="animatedModal" class="animated-modal">
      <h3 class="wxscan">感谢打赏</h3>
      <div class="wxscanimg">
        <p class="wxloading"> <img src="<?php echo __LAZYIMG__; ?>" data-src="<?php echo fullurl($this->options->donate_img,0); ?>" id="shangqr"/> </p>
      </div>
  ...
  <div class="footer-ext">
    <ul>
      <?php if (!empty($this->options->wangbei)):?>
      <li>
        ...
        <?php endif; ?>
        <a href="<?php if($this->options->wailian){echo $this->options->wailian;} ?>http://www.miibeian.gov.cn" target="_blank" rel="nofollow"><?php echo $this->options->wangbei ;?></a></li>
      <?php endif; ?>
      <?php if (!empty($this->options->anbei)):?>
      <li>
        <?php if(!empty($this->options->advanced) && in_array('AutoFimg', $this->options->advanced)): ?>
        <img src="<?php echo Typecho_Widget::widget('Widget_Options')->themeUrl;?>/img/ghs.png">
        <?php endif; ?>
        <a href="<?php if($this->options->wailian){echo $this->options->wailian;} ?>http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=<?php echo getanbei() ;?>" target="_blank" rel="nofollow"><?php echo $this->options->anbei ;?></a></li>
      <?php endif; ?>
    </ul>
  </div>
...
<ul id="scroll">
  ...
  <div style="display: none;" id="animatedModal_Sidehb" class="animated-modal">
    ...
    <div class="wxscanimg">
      <p class="wxloading"> <a href="<?php echo $this->options->sideurl; ?>" target="_blank" title="<?php echo $this->options->sidealt; ?>"> <img src="<?php echo __LAZYIMG__; ?>" data-src="<?php echo fullurl($this->options->sidehb_img,0); ?>" id="sidehbqr"/> </a> </p>
    </div>
...
<div style="display: none;" id="animatedModal3" class="animated-modal">
  <h3 class="wxscan postqr">添加好友</h3>
  <div class="wxscanimg">
    <p class="wxloading"> <img src="<?php echo __LAZYIMG__; ?>" data-src="<?php echo fullurl($this->options->ismewechat,0);?>" class="aboutme" id="groupqr"> </p>
  </div>
...
<script type="text/javascript" data-no-instant="true" src="<?= THEME_URL ?>/js/instantclick.js"></script>
<?php endif; ?>
...
<!--</nocompress>-->
</body></html><?php if (!empty( Helper::options()->switchEnable ) && in_array('EnableCompression',Helper::options()->switchEnable)){
