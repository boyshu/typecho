...
<div id="main" class="main">
  <article class="article" id="article">
    <div class="article-box card">
      ...
      <div class="article-meta"> <span class="meta-item" title="本文作者"><i class="fa fa-user-o text-muted"></i>作者: <a class="meta-author" href="<?php $this->author->permalink(); ?>" rel="author">
        <?php $this->author(); ?>
        </a></span> <span class="meta-item" title="发表日期"><i class="fa fa-clock-o text-muted"></i>发表:
        <?php $this->date('Y/m/d'); ?>
        </span> <span class="meta-item" title="评论次数"><i class="fa fa-comments-o text-muted"></i>评论:<a href="#comments">
        <?php $this->commentsNum('0', '1', '%d'); ?>
        条</a></span> <span class="meta-item" title="浏览次数"><i class="fa fa-eye text-muted"></i>浏览:
        <?php get_post_view($this) ?>
        次</span>
        <?php if(isset($this->options->plugins['activated']['Like'])): ?>
        <span class="meta-item" title="点赞次数"><i class="fa fa-thumbs-up text-muted"></i>喜欢: <a href="#shang-like">
      ...
      <div class="shang-like" id="shang-like">
        <div id="social">
          <div class="social-main" id="social-main"> <span class="like">
            ...
            <?php endif; ?>
            </span> <span class="social-notice">如果觉得我的文章对你有用，请随意赞赏</span> </div>
          <?php if(!empty($this->options->donate_img)): ?>
          <div class="fancybox-slide--current social-main" id="social-shang" style="display: none;"> <span class="like"> <a data-fancybox data-animation-duration="700" data-src="#animatedModal" href="javascript:;" class="post-like" id="index-shang">赏</a> </span> <span class="social-notice">如果觉得我的文章对你有用，请随意赞赏</span> </div>
          <?php endif; ?>
        </div>
      </div>
      <?php endif; ?>
