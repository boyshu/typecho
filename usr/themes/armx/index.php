...
<div class="main" id="main" role="main">
  <?php if ($this->have()): ?>
  <h3 class="box-label"><span class="label-left"></span><span class="box-name">最近更新</span></h3>
  <?php while($this->next()): ?>
  <article class="post">
    <div class="card post-box clearfix">
      <div class="post-thumbnail">
        <?php the_post_cat($this);?>
      ...
      <div class="post-body">
        ...
        <div class="post-content">
          ...
          ......</div>
        <div class="post-meta"> <a class="meta-item" href="<?php $this->author->permalink(); ?>"  title="" rel="author"><i class="fa fa-user-o text-muted"></i>
          <?php $this->author(); ?>
          </a> <span class="meta-item" title="" id="meta-date"><i class="fa fa-clock-o text-muted"></i><a href="<?php $this->options->rootUrl();?>/<?php $this->date('Y/m'); ?>/" title=""><?php echo $this->dateWord; ?></a></span> <span class="meta-item" title="" id="meta-view"><i class="fa fa-eye text-muted"></i>阅读(<a href="<?php $this->permalink() ?>">
          <?php get_post_view($this) ?>
          </a>)</span> <span class="meta-item" title="" id="meta-comment"><i class="fa fa-comments-o text-muted"></i>评论(<a href="<?php $this->permalink() ?>#comments">
          <?php $this->commentsNum('0', '1', '%d'); ?>
          </a>)</span>
          <?php if(isset($this->options->plugins['activated']['Like']) && $this->options->isdonate == '1'): ?>
          <span class="meta-item" title="" id="meta-like"><i class="fa fa-heart-o text-muted"></i>喜欢(
          <?php Like_Plugin::indexLike(); ?>
          )</span>
          <?php endif;?>
        </div>
      </div>
