...
<div id="main" class="main">
  <h3 class="box-label"><span class="label-left"></span><span class="box-name" id="box-name">
    <?php $this->title() ?>
    </span></h3>
  <article class="article">
    <div class="article-box card">
      <div class="article-content linkspage">
        ...
        <div class="links">
          <ul>
            <li> <a href="https://vircloud.net" target="_blank" data-no-instant rel="nofollow"><span class="sitename">VirCloud's Blog</span>
              <div class="linkdes">Learning & Sharing.</div>
              </a> </li>
            <?php 
    $mypattern = '
    <li>
